...
/**
 * Test script for validation middleware with proper curl commands
 */

import { spawn } from 'child_process';

console.log('Testing Zsiistant Request Validation Middleware with proper JSON...\n');

// Test cases with correct JSON formatting
const testCases = [
  {
    name: 'Valid POST request with correct JSON',
    method: 'POST',
    path: '/api/agents',
    body: {
      name: 'TestAgent',
