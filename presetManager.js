...
const { presetSchema, createPresetSchema, updatePresetSchema, builtInPresets } = require('./preset-schema');
...
class PresetManager {
   ...
   */
  async applyPreset(presetId, userId) {
    try {
